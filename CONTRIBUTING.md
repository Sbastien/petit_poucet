...
```text
lib/
├── petit_poucet.rb           # Main entry point, conditional Rails requires
└── petit_poucet/
    ├── version.rb            # Version constant
    ├── breadcrumb.rb         # Immutable breadcrumb value object (Data.define)
    ├── breadcrumbs.rb        # Core collection class (pure Ruby)
    ├── presenter.rb          # View presenter wrapping a breadcrumb
    ...
    └── test_helpers.rb       # RSpec matchers and Minitest assertions
```

## Key Concepts

- **Breadcrumbs**: Pure Ruby collection class, no Rails dependencies
- **Breadcrumb**: Immutable value object using Ruby 3.2+ `Data.define`
